...
<div class="cluster-card" data-name="ascend-cn12-001-cluster">
  ...
  <div class="cluster-body">
    ...
    <div class="project-row" data-search="vllm-project/vllm-ascend linux-aarch64-a3-0 a3-560t linux-aarch64-a3-2 linux-aarch64-a3-4 linux-aarch64-a3-8 linux-aarch64-a3-16 linux-aarch64-a3-800t-2 linux-aarch64-a3-800t-4 linux-aarch64-a3-800t-8 linux-aarch64-a3-800t-16 linux-amd64-cpu-4 linux-aarch64-cpu-4">
      <div class="project-line">
        <button type="button" class="project-head" aria-expanded="false">
          <span class="project-toggle"></span>
